...
class ApplicationController < ActionController::Base
  ...
  def auth_user
    ...
    # if it is removed, strange errors "undefined class/module User" appear

    id = nil
    external_session_cookie = cookies[AppConfig.external_session]
    if external_session_cookie.present?
    ...
    sign_out current_user if logged_in? && (id.blank? || current_user.external_id != id)
    return if id.blank?
